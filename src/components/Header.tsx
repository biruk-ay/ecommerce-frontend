...
const Header = () => {
    ...
    return (
        <>
            <header className="bg-primary top-0 h-16 w-auto">
                <nav className="flex auto max-w-6xl justify-between lg:px-8" aria-label="Global">
                    ...
                    <form className="flex auto items-center max-w-xl mx-auto">
                        <div className="relative w-full flex auto">
                            <div className="absolute inset-y-0 start-0 flex items-end">
                    ...
                    <div className="flex auto pb-40 justify-end gap-4 font-roboto font-bold">
