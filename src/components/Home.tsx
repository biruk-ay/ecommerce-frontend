  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex top-0 w-full justify-evenly items-center text-white">
        <img
          className="w-11/12 justify-evenly items-center"
          src={topImage}
          alt="top image"
        />
      </div>
      <div className="w-11/12  h-max mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-0 bg-slate-100 -mt-40 mb-5">
        ...
        >
          ...
          <div className="px-6 py-4">
            <h1 className="font-semibold text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out">
              Shoes
            </h1>
        ...
        <div
          className="w-72 h-90 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl"
