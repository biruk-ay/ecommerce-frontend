...
function UpdateProduct() {
 ...
 const handleCategorySelect = (selectedCategory: React.SetStateAction<string>) => {
  ...
  return (
    <>
      <Header />
        ...
        <div className="bg-white mt-10 flex flex-col sm:flex-row justify-evenly w-11/12">
          ...
          <div className="flex text-4xl"> <h1 >Update Product</h1></div>
                ...
                {clicked && (
                  <div className="bg-white w-52 mt-2 m-8  border border-gray-300 rounded flex ">
                    <ul className=" text-center">
                      ...
                      <li className="  py-2 w-52 border  shadow-md rounded-sm hover:bg-fuchsia-900  hover:border-slate-300cursor-pointer" onClick={() => handleCategorySelect("Category C")}>
                        Category C
                      </li>
                      <li className="  py-2 w-52 border  shadow-md rounded-sm hover:bg-fuchsia-900  hover:border-slate-300 cursor-pointer" onClick={() => handleCategorySelect("Category D")}>
                        Category D
                      </li>{" "}
                    </ul>
                  </div>
    ...
    <button className="border border-gray-500 rounded-3xl bg-violet-600 text-white w-[228.8px] h-[40px] " onClick={productUpdate} >Update Product</button>
</div>
        </div>
